...
$memberkfa->displayname = $json['user']['displayName'];
    ...
    echo '<p>First name: ' . $memberkfa->firstname . '<br>';
    echo 'Last  name: ' . $memberkfa->lastname . '<br>';	
    echo 'Email: ' . $memberkfa->emailaddress. '<br>';
    echo 'Manage: ' . $memberkfa->manage.'</br>';
    echo 'Newly Diagnosed: ' . $memberkfa ->newlydiagnosed .'<br>';
    echo 'Playgroups: ' . $memberkfa ->playgroups . '<br>';
    echo 'Subscribe: ' . $memberkfa ->subscribe . '<br>';
    echo 'Refered By: ' . $memberkfa ->reference . '<br>';
    echo 'Food Allergy Managed: '. $memberkfa ->foodopt1;
    echo $memberkfa ->foodopt2;
    echo $memberkfa ->foodopt3;
    echo $memberkfa ->foodopt4;
    echo $memberkfa ->foodopt5;
    echo $memberkfa ->foodopt6;
    echo $memberkfa ->foodopt7;
    echo $memberkfa ->foodopt8;
    echo $memberkfa ->foodopt9;
    echo $memberkfa ->foodopt10;
    echo $memberkfa ->foodopt11;
    echo $memberkfa ->foodopt12;
    echo $memberkfa ->foodopt13;
    echo $memberkfa ->foodopt14;
    echo $memberkfa ->foodopt15;
    echo $memberkfa ->foodopt16;
    echo '<br><br>';
	...
	{	
		...
		{
			$op6 = get_foodallergy($memberkfa ->foodopt6);
		...
		{
			$op7 = get_foodallergy($memberkfa ->foodopt7);
			$url .= '&individualAccount.customFieldDataList.customFieldData.fieldId=105&individualAccount.customFieldDataList.customFieldData.fieldOptionId='.$op7 .'&individualAccount.customFieldDataList.customFieldData.fieldValue=';
		}
