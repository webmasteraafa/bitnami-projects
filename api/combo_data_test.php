    ...
    do 
    {
       ...
       $password=""; 
        ...
        // Set some options - we are passing in a useragent too here
         curl_setopt($ch, CURLOPT_URL, 'https://community.aafa.org/api/v1/members/?m_id=457293735035228056&page=' . $p);
