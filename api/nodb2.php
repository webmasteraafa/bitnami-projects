...
$memberaafa -> id =  $json['members'][5]['user']['id'];
...
$memberaafa->location = $json['user']['location'];
$city = array();
$city = (explode(",",$memberaafa->location));
...
if (!empty($memberaafa ->firstname))
{
	...
	$url .= '&individualAccount.primaryContact.address.address.city='.$city[0];
	$url .= '&individualAccount.primaryContact.address.address.state.code=' .$city[1];
