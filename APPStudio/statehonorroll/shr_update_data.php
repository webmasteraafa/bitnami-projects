<?php
$title = "State Honor Roll Update Data Form";
...
<body>
   ...
   ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">State Honor Roll Update Data Form</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
      			...
      			<div class="col-lg-9 col-md-9 col-sm-9">
    				...
    				<div class="form-group">
    					<div class="col-sm-offset-2 col-sm-4">
      						<button type="submit" name="action" value="update" class="btn btn-default">Send State Data</button>
    					</div>
    				</div>
