...
<body>
   ...
   ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">AdGlare Zone Group List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<tr><td>Zone Group ID</td><td>Zone Group Name</td><td>Status</td><td>Impressions</td><td>Clicks</td></tr>
<?php 
