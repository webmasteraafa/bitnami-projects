...
<tr><td>Zone ID</td><td>Zone Group ID</td><td>Zone Name</td><td>Status</td><td>Impressions</td><td>Clicks</td><td>View Report</td></tr>
<?php 

for ($x=0; $x<=$arr_length; $x++)
{	
echo '<tr><td>';
echo $json[response][data][$x][zID];
echo '</td><td>';
echo $json[response][data][$x][zgID];
echo '</td><td>';
...
echo '</td><td>';
echo '<a href="zone_report.php?id=';
echo $json[response][data][$x][zID];
echo'">';
echo $json[response][data][$x][zID];
echo'</a></td></tr>';
