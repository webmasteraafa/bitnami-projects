...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/recipesmain.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<!-- InstanceBeginEditable name="doctitle" -->
<title>Free Allergy Recipes: Chicken Rice Salad</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="Keywords" content="allergy free recipe, peanut free, dairy free recipes, dairy free, food allergies, food allergy, POFAK, kids with food allergies, egg free, wheat free, nut free, food allergy recipes, chicken, rice, salad, chicken rice salad, fruity salad" />
<meta name="Description" content="Fruity Chicken and Rice Salad:  This free featured recipe offers an allergy-free side dish made without dairy, soy, egg, wheat, nuts, corn, and other common allergens. The Kids With Food Allergies allergy-free recipe database is filled with hundreds of recipes that are allergy-friendly. " />
...
<!-- InstanceParam name="onload" type="text" value="preloadImgs();randomImages();" -->
</head>
...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" --> 
		Featured Allergy-Free Recipe: Fruity Chicken &amp; Rice Salad<!-- InstanceEndEditable --></h1>
</div>
	            ...
	            <tr>
                  ...
                  <table border="0" align="center" cellpadding="1" cellspacing="2" id="ingredients" >
                     ...
                     <td class="title" align="center">
                       <b>Allergy-Free Side-Dish Recipe:</b> <?php echo "<b>$db_name </b>"?>
                  ...
                  <table align="center" border="0" cellpadding="1" cellspacing="2" id="information" >
				    ...
				    <?php if($db_source) {echo 'Recipe Created By: '.$db_source.'<br>';} ?></td><td width="60" valign="top"><script type="text/javascript">digg_url = 'http://www.kidswithfoodallergies.org/chicken_rice_salad.php'; digg_bgcolor = '#C0E688'; digg_skin = 'normal'; digg_window = 'new';</script><script src="http://digg.com/tools/diggthis.js" type="text/javascript"></script></td>
                	    </tr>
       		   <tr>
       		     <td></td></td></tr>
            <tr>
		...
		<tr>
		    <td>
	        	    ...
	        	    <tr>
                	    ...
                	    <tr class="cellbg">
                    	 	<td class="resultspacing"><?php if($db_submitter_comments) {echo $db_submitter_comments;} ?></td>
                	    </tr>
            		</table>        	    </td>
    		</tr>
        ...
        $other_allergens = substr($other_allergens,0, (strlen($other_allergens) - 2));
         ...
         <tr>
            <td class="celltitlebg" width="78">
              <input id="milkfree" type="checkbox" disabled="disabled" name="milkfree" <?php if (is_array($allr_legends) && (in_array("M", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">M</span>ilk</td>
            <td class="celltitlebg" width="78">
              <input id="peanutfree" type="checkbox" disabled="disabled" name="peanutfree" <?php if (is_array($allr_legends) && (in_array("P", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">P</span>eanut</td>
            <td class="celltitlebg" width="78">
              <input id="eggfree" type="checkbox" disabled="disabled" name="eggfree" <?php if (is_array($allr_legends) && (in_array("E", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">E</span>gg</td>
            <td class="celltitlebg" width="78">
              <input id="soyfree" type="checkbox" disabled="disabled" name="soyfree" <?php if (is_array($allr_legends) && (in_array("S", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">S</span>oy</td>
            <td class="celltitlebg" width="78">
              <input id="nutfree" type="checkbox" disabled="disabled" name="nutfree" <?php if (is_array($allr_legends) && (in_array("T", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">T</span>ree nut</td>
            <td class="celltitlebg" width="78">
              <input id="cornfree" type="checkbox" disabled="disabled" name="cornfree" <?php if (is_array($allr_legends) && (in_array("C", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">C</span>orn</td>
         </tr>
         <tr>
            <td class="celltitlebg" width="78">
              <input id="glutenfree" type="checkbox" disabled="disabled" name="glutenfree" <?php if (is_array($allr_legends) && (in_array("G", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">G</span>luten</td>
            <td class="celltitlebg" width="78">
              <input id="wheatfree" type="checkbox" disabled="disabled" name="wheatfree" <?php if (is_array($allr_legends) && (in_array("W", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">W</span>heat</td>
            <td class="celltitlebg" width="78">
              <input id="fishfree" type="checkbox" disabled="disabled" name="fishfree" <?php if (is_array($allr_legends) && (in_array("F", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">F</span>ish</td>
            <td class="celltitlebg" width="78">
              <input id="shellfishfree" type="checkbox" disabled="disabled" name="shellfishfree" <?php if (is_array($allr_legends) && (in_array("Sh", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">Sh</span>ellfish</td>
            <td class="celltitlebg" width="78">
              <input id="sesamefree" type="checkbox" disabled="disabled" name="sesamefree" <?php if (is_array($allr_legends) && (in_array("Ses", $allr_legends))) echo "checked";?> />
            &nbsp;<span class="allergenKey">Ses</span>ame</td>
            <td class="celltitlebg" width="78">&nbsp;            </td>
         </tr>
         <tr>
           <td class="celltitlebg" colspan="6">
             <input id="other" type="checkbox" disabled="disabled" name="other" <?php if (is_array($allr_legends) && (in_array("O", $allr_legends))) echo "checked";?> />
           &nbsp;<span class="allergenKey">O</span>ther
           <input type="text" disabled="disabled" class="defaultfont" name="other1" size="60" id="other1" value="<?php echo $other_allergens; ?>" />           </td>
         </tr>
      </table> <p>&nbsp;</p><b>Copyright Policy:</b></p>
            <p><em>Recipes are shared for your <strong>personal use only</strong>.</em>            </p>
            <p>You are welcome to enjoy these recipes, but please don't reprint, 
              electronically reproduce, repost or redistribute recipes elsewhere without <a class="style30" href="email.php?to=info;" onclick="MM_openBrWindow('email.php?to=info','','width=500,height=500');return false">obtaining 
                permission</a>. For more information, see our <a href="http://www.kidswithfoodallergies.org/tos.html">terms of 
                  service</a>.            </p>
            <p><em>Copyright &copy; 2005-2008, Kids With Food Allergies, Inc. All rights reserved.</em></em></p></td></tr></table>
...
<!-- #BeginEditable "date" -->
      <p align="center" class="style24">Page last updated 6/03/2008</p>
      <!-- #EndEditable --></div>
<div class="mainbox2" align="center">
<div class="blueinsidebox">
  	<span class="style61">KFA is a national nonprofit food allergy organization  dedicated to fostering optimal health, 
...
pageTracker._trackPageview("/recipes");
</script>
<!-- InstanceEndEditable -->
