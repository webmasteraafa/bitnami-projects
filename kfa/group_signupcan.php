...
<head>
<!-- InstanceBeginEditable name="doctitle" --><title>Signup a Support Group</title>
...
<div class="ltgreyboxmainR">
  ...
  <tr>
     <td align='center' ><b><h2> Add a Support Group Application </h2></b></td>
  </tr>
  <tr>
<td align='center' class="style19"> To create a support group, please fill out the following application and click the 
"Create Support Group" button. </td>
  </tr>
</table>
<br>

<table align='center' width='0%' border='0' class="style19">
  <form action="do_group_signup.php" method="POST" onsubmit="return validateGroupSignup(this)">
  <input type="hidden" name="location2" value="canada">
    <tr>
      <td width='50%'>  <strong>Group Name</strong>: </td> 
      <td> <input type='text' name='name' id='name' rowspan="2" onblur="return commonCheck(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>City/Region</strong>:  </td>
      <td> <input type='text' name='area' id='area' rowspan="2" onblur="return commonCheck(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>Audience</strong>: (parents only, adults with food allergies, etc.)  </td>
      <td> <input type='text' name='audience' id='audience' rowspan="2" onblur="return commonCheck(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>Type of group</strong>: (education, advocacy, social and emotional support, playgroup, other (specify))  </td>
      <td> <input type='text' name='focus' id='focus' rowspan="2" onblur="return commonCheck(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>Meeting Location</strong>: (if it varies, state "varies") </td>
      <td> <input type='text' name='location' id='location'  rowspan="2" onblur="return commonCheck(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>Meeting Frequency</strong>: (e.g., "meets monthly", "meets third Weds of month", "varies", or "10 times a year", etc.)  </td>
      <td> <input type='text' name='meetings' id='meetings'  rowspan="2" onblur="return commonCheck(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>Coordinator(s) Name</strong>:  </td>
      <td> <input type="text" name="coordinator" id='coordinator'  rowspan="2" onblur="return commonCheck(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>Phone Number</strong>: (optional) </td>
      <td> <input type="text" maxlength="3" name="areacode" id="areacode" size="3" rowspan="2"  />
           <input type="text" maxlength="3" name="three_digit_ph" id="three_digit_ph" size="3" rowspan="2" >
           <input type="text" maxlength="4" name="four_digit_ph" id="four_digit_ph" size="4" rowspan="2" > </td>
    </tr>
    <tr>
      <td>  <strong>Email Address</strong>:  </td>
      <td> <input type='text' name='email' id='email' rowspan="2" onblur="return validateEmail(this, true)" /> </td>
    </tr>
    <tr>
      <td>  <strong>Web site</strong>: (optional)  </td>
      <td> <input type='text' name='website' id='website' rowspan="2" /> </td>
    </tr>
    <tr>
      <td>  <strong>Province located</strong>: 
	...
	<tr><td><strong>Does group have a physician Medical Advisor?</strong></td>
	<td><input type="radio" name="physician" value="yes"> YES <input type="radio" name="physician" value="no"> NO</td></tr>
	<tr><td><strong>Is group affiliated with AAFA</strong> (www.aafa.org)?</td>
	<td><input type="radio" name="affiliated" value="yes"> YES <input type="radio" name="affiliated" value="no"> NO</td></tr>
	<tr><td><strong>Is group on FAAN list of support groups</strong> (www.foodallergy.org)?</td>
	<td><input type="radio" name="faan_list" value="yes"> YES <input type="radio" name="faan_list" value="no"> NO</td></tr>		
	<tr><td colspan='2'><strong>Description of group</strong> (50 words or less:)</td>
	</tr>
    ...
    <tr> 
     ...
     <form action="groups.php">
       ...
       value="Go Back to Groups"></td>
        ...
        <strong>Adding your group includes: </strong></p>
    <ul>
      <li> Free Associate Membership including access to the Food Allergy   Organization Leaders' Forum </li>
      <li> A free   subscription to KFA<strong><em> e-news</em></strong><em></em>, a twice monthly   e-newsletter </li>
      <li> A complimentary subscription   to KFA's<strong></strong><strong><em> Support   Net</em></strong><em></em>, a twice-yearly print   newsletter </li>
      <li> A free subscription to   KFA's<strong></strong><strong><em> Support Groups   Rock</em></strong><em></em>, a periodic e-newsletter for   Support Group Leaders <br />
      </li>
    </ul>
...
<!-- #BeginEditable "date" -->
      <p>Page last updated 1/21/2008</p>
      <!-- #EndEditable --></div>
