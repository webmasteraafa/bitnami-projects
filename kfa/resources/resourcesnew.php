...
<tr>
    <td><div class="balloon"><ul><li><a href="http://www.kidswithfoodallergies.org/resourcetopic.php?topic=freeguides" class="style19"><img src="../images/rec/guides.jpg" width="105" height="91" alt="Food Allergy Guides" align="left" style="padding:3px;" border="0"/><strong class="style19">Free Guides<br />
    ...
    <span style="color:#3F679B; text-decoration:underline">Learn More...</span></a></li></ul></div>
      ...
      <div class="balloon"><ul><li><a href="http://www.kidswithfoodallergies.org/resourcetopic.php?topic=supportnet" class="style19"><img src="../images/rec/supportnetnp.jpg" width="105" height="91" alt="Support Net Magazine" align="left" style="padding:3px;" border="0" /><strong class="style19">Support Net&reg;<br />
...
<tr>
  <td>
  <div class="balloon"><ul><li><a href="http://www.kidswithfoodallergies.org/newsletter.html" class="style19"><img src="../images/rec/enewsnp.jpg" width="105" height="91" alt="KFA eNews" align="left" style="padding:3px;" border="0" /><strong class="style19">KFA eNews</strong><br />
...
<?php 
	...
	$result = mysql_query( $sql ) or die( mysql_error() );
		...
		while( $row = mysql_fetch_array( $result ) )
		{
			...
			if ($topic == 'rising-stars') $smalldescrip = "Real life stories of kids living with food allergies.";
