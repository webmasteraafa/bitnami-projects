        ...
        <td colspan="2" bgcolor="#FFFFFF">-->
         <div class="recipesgreyboxmain" style="color:#333333">
          ...
          <tr valign="top" bgcolor="#CCCCCC" align="left">
            <td colspan="2" bgcolor="#FFFFFF">         <form action="SearchHandling2014.php" method="POST" name="searchform" onsubmit="validate();">
                  <table align="center" border="0" cellpadding="1" cellspacing="2" id="Table3" width="528">
                     <tr>
                        <td class="header" colspan="2" width="506">&nbsp;Recipe Search <a href="search_tips.html;" onclick="MM_openBrWindow('http://kidswithfoodallergies.org/recipes/help.html','','width=550,height=280,toolbar=no,scrollbars=yes');return false">(Click here for Search Tips)</a></td>
                     </tr>
                     <tr>
