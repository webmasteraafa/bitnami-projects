...
echo '<div>';
echo '<span  class="style70"><img src="'.$rater_stars.'?x='.uniqid((double)microtime()*1000000,1).'" alt="'.$rater_stars_txt.' stars" /> Avg. rating: '.$rater_stars_txt.' from </span><span class="style70"> '.$rater_votes.' votes</span>.';
echo '</div>';
echo '<div>';
