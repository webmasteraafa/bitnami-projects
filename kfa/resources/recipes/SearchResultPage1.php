...
<meta name="keywords" content="recipes, search, results, allergen legend">
...
<table class="background" cellpadding="0" cellspacing="0" border="0" align="center" width="750">
   <tr>
      <td valign= "top" width="180">
         <?
           /*Imports the left navigation panel for viewing*/
         ...
         <table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
          <tr valign="top" bgcolor="#CCCCCC" align="left">
            <td height="33" colspan="2" valign="middle" bgcolor="#3F679B"><div align="left">
              <h1>&nbsp;&nbsp;&nbsp;
 Recipes: Search Results</h1>
            </div></td>
          </tr>
        </table>

         <table width="575" align="center" border="0" class="style19" cellpadding="5" cellspacing="2" bgcolor="#E1E1E1">
          <tr valign="top" bgcolor="#CCCCCC" align="left">
