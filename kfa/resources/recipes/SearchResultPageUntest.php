...
<meta name="keywords" content="recipes, allergen, search results">
...
<script language="javascript" src="http://www.kidswithfoodallergies.org/js/menu.js" type="text/javascript"></script>
   ...
   <script language="JavaScript" type="text/javascript">
	...
	function handleButton(){
        ...
        if(document.pressed == 'UnApprove'){
           document.listedrecipes.action = "SearchResultHandling.php?button=unapprove";
        }
...
<table class="background" cellpadding="0" cellspacing="0" border="0" align="center">
 ...
 Recipes
         ...
         <table width="575" class="style19" align="center" border="0" cellpadding="5" cellspacing="2" bgcolor="#E1E1E1">
          <tr valign="top" bgcolor="#CCCCCC" align="left">
          ...
          <!-- Show Results Table -->
            ...
            <tr>
               <td class="background" colspan="5" align="center">
                  <?php
                       //Code that only displays Unapprove and delete buttons if administrator
    	               if ($usertype == 'admin'){
                     if ($fromPage == 'approved'){
                        echo "&nbsp;<INPUT type=\"SUBMIT\" name=\"Un-Approve\" onClick=\"document.pressed=this.value\" value=\"UnApprove\">&nbsp;";
                        echo "&nbsp&nbsp&nbsp";
                     }
