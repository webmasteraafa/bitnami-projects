...
<table class="background" cellpadding="0" cellspacing="0" border="0" align="center" width="1000">
       ...
       <!--<table width="568" class="style19" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#E1E1E1">
        ...
        <td colspan="2" bgcolor="#FFFFFF">-->
         	<div class="recipesgreyboxmain" style="color:#333333">
              <!--closed-->  <table border="0" align="center" cellpadding="1" cellspacing="2" id="ingredients" width="720">
                     <tr>
                     	<td>
                     		<h2 align="center">Search Results: Browse Allergy-Friendly Recipes </h2>
                      <!-- INSERT CONTENT HERE table 192 closed -->
            ...
            <!--form-->     <form method=POST name=listedrecipes onSubmit="handleButton();">
             ...
             <!-- Allergen Legend Table closed -->
                				...
                				<?php echo "<td class=\"header\" colSpan=\"6\" width=\"506\">&nbsp;Allergen Legend:</td>"?>
            								...
            								</table> <!--closes table 198 tblAllergenInfo-->
            ...
            <!-- Result Paging Table closed -->
                                        ...
                                        </table> <!-- closes table 224 pagingtable-->
   </td></tr></table><!--new-->
            <!-- Search Result Label closed -->
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="568">
                                           <tr>
                                        ...
                                        </table><!--closes table 252 result label-->

          <!-- Show Results Table -->
			 						<table border="0" cellpadding="0" cellspacing="2" ID="resultTable" width="568">
                                        <tr>
                                       ...
                                       <td align="center" class="celltitlebg" width="100"> &nbsp;Created By </td>
                                        ...
                                        </table><!--closes table 261 resultTable below table 270 is closed-->
                                    ...
                                    <tr>
                                      <td colspan="5" align="right" class="normal">
                                        <a href="http://www.kidswithfoodallergies.org/recipes/search.php">Search Again</a>
                                      </td>
                                      </tr>
                                      <!--                          
                                        <tr>
  ...
  <h2> Recipe Help</h2>
      <p class="style19">                   If you have any questions or comments about any of the recipes in Safe Eats&trade;, <a href="http://community.kidswithfoodallergies.org/createForumContent/forum/safe_eats_comments">start a discussion topic</a> now or click &quot;have a question about this recipe&quot; on the recipe's page. This will lead you to discuss the recipe with our Food &amp; Cooking Support Team and other fellow members on our <a href="http://community.kidswithfoodallergies.org/category/food-and-cooking-support">Food &amp; Cooking Support Forums</a>.  They can help you alter a recipe to make it allergy-free for your child's needs.  Registration is free!</p> <br />
				...
				<ol>
					  ...
					  <li class="style19">Use of the database indicates the user's agreement
						    with our terms of service.</li>
		</ol> <br /><br /><p  class="style19"><b>Copyright Policy: Copyright &copy; 2005-2014, Kids With Food Allergies. All rights reserved.</b></p>
            <p class="style19"><em>Recipes are shared for your <strong>personal use only</strong>. </em></p>
            <p class="style19">You are welcome to enjoy these recipes and share links to our recipes, but please don't reprint, 
...
</table><!--closes 186 ingredients-->
</div>
</td></tr></table><!--closes main table background-->
  ...
  <table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td>	
      <p align="center" class="style24">Page last updated 01/08/2014</p>
       </td></tr>	  
         <tr><td>
         <?php
...
pageTracker._trackPageview("/Recipe Search Results");
} catch(err) {}</script>
