<?php
 ...
 // }
  ...
  $query = "SELECT APPROVAL_DATE, RECIPE_ID, NAME, SOURCE FROM TBL_RECIPE
            WHERE APPROVED = 'Y'AND DELETED = 'N' AND iron_chef = 'yes' order by NAME";
...
/*
//Get this month and only show recipes that are approved for the past 30 days
$thismonth = date(m);
$lastmonth = date(m)-1;
