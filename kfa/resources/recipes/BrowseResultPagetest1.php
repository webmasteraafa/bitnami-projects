...
<meta name="keywords" content="allergy recipes, food allergies, Safe Eats">
<meta name="description" content="Browse Safe Eats recipes results.">
...
<script language="javascript" src="http://www.kidswithfoodallergies.org/js/menu.js" type="text/javascript"></script>
   ...
   <title>Browse Recipes Results</title>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
          <tr valign="top" bgcolor="#CCCCCC" align="left">
            <td height="33" colspan="2" valign="middle" bgcolor="#3F679B"><div align="left">
              <h1>&nbsp;&nbsp;&nbsp;
 Safe Eats&#8482; Recipes	</h1>
            </div></td>
          </tr>
        </table>

      <!-- Allergen info table -->
      <table width="585" align="center" border="0" cellpadding="5" cellspacing="2" bgcolor="#E1E1E1" class="style19">
          <tr valign="top" bgcolor="#CCCCCC" align="left">
      ...
      <br><br>
      <p align="center"><input type="submit" name="Filter" onClick="document.pressed=this.value" value="Refine Search"></p>
<?php
...
<input type="hidden" value="<?php echo $category; ?>" name="browse_category">
   ...
   <table border="0" cellpadding="0" cellspacing="2" ID="PagingTable" width="470" align="center">
      <tr>
         <td colspan="2" align="right" class="normal" style="padding-right:35px;">
             <?php
   ...
   <!-- Paging bar -->
   <table align="center" border="0" cellpadding="0" cellspacing="0" width="470">      <tr>
         <td class="headerleft">&nbsp;Browse Results (<?=$first?> - <?=$last?> of <?=$totRecipes?>)</td>
         <td class="headerright">page <?=$current?> of <?=$total?></td>
      </tr>
   </table>
   <!-- Search criteria table -->
   <table align="center" border="0" cellpadding="1" cellspacing="2" ID="titleTable" width="470"><!--508 -->
		<tr>
			<td align="center" class="celltitlebg" width="30"><?php if($usertype == 'admin') echo "<INPUT type=checkbox onClick=\"handleTopOfList()\">";?> </td>
			<td align="center" class="celltitlebg" width="226">&nbsp;Recipe Name&nbsp;<a onClick="showHelp('recipenamebrowse')" href="javascript:void(0)"><img src="images/BtnHelpG.gif" border="0" alt="show help: recipe name"></a> </td>
         <td align="center" class="celltitlebg" width="100">&nbsp;Created By&nbsp;<a onClick="showHelp('sourcebrowse')" href="javascript:void(0)"><img src="images/BtnHelpG.gif" border="0" alt="show help: source"></a> </td>
			<td align="center" class="celltitlebg" width="112">&nbsp;Allergen Free&nbsp;<a onClick="showHelp('allergenfreebrowse')" href="javascript:void(0)"><img src="images/BtnHelpG.gif" border="0" alt="show help: allergen free"></a> </td>
		</tr>
	</table>
