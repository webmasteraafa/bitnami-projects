...
<!--                   <td align="center" width="*">
            <img src="http://www.cc.gatech.edu/classes/AY2005/cs3911b_fall/Projects/Team1/images/hdrRecipes.gif" border="0"
		alt="Recipes" align="middle">
            <br><br>
-->
            <?php
	      ...
	      $result3 = mysql_query($sql3) or trigger_error(mysql_error(), E_USER_ERROR);
            ...
            <table align="center" cellpadding="2" cellspacing="10" class="style19">
             ...
             <table align="center" border="0" cellpadding="1" cellspacing="2" ID="ingredients" width="468">
               <tr>
                 <td class="titleprint" align="center" width="460">
                   <?php echo $db_name; ?>
                 </td>
               </tr>
	...
	<span class="style1"><b>Disclaimer</b><br>
1) These recipes have been donated by our members and have not been tested in a test kitchen, therefore we can't guarantee the results. 2) Safety of ingredients is important. As we all know the same product manufactured in different plants at different parts of the country may not contain the same ingredients. 3)For the &quot;free of&quot; categorization, you should not make any assumptions as to the safety of an ingredient that is included in any of these recipes. It will be up to you to do your own research to make sure that each ingredient in these recipes is indeed safe for your child's unique allergy issues. 4) Use of the database indicates the user's agreement with our terms of service.
	</span>
	</td>
	</tr>         
