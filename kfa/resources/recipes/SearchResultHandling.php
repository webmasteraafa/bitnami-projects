<?php
     ...
     $currentPage = "SearchResultHandling";
      ...
      //Handle unapprove functionality if pushed
       if($_GET[button] == "unapprove"){
      ...
      //Handle delete functionality if pushed
      if($_GET[button] == "delete"){

         handleDelete();

         //This will fill the results_array with all the search results
         handleSearch($_SESSION['keyword'], $_SESSION['course'], $_SESSION['allergens'], $_SESSION['exclude']);

         //Session will be accessed by search results page
