...
{ alert('This Page is fully protected!'); return false; } return true; } document.onmousedown=right; if (document.layers) 
...
<body width="550" ondragstart="return false" onselectstart="return false" oncontextmenu="return false;" onload="stopDrag()">
   <?php
             ...
             <table align="center" border="0" cellpadding="1" cellspacing="2" ID="ingredients" width="468">
               ...
               <tr>
                 <td class="normal" align="right" width="468">
                    <a href='javascript:window.print()' style="no-print">
                     click to print
                    </a>
                 </td>
               </tr>
         ...
         echo '<br>';
		    ...
		    <td>
	        	    ...
	        	    <tr>
                	    ...
                	    <tr class="cellbgprint">
                    		<td width="460"><div class="noprint"><?php if($db_instructions) {echo $db_instructions;} ?></div></td>
                	    </tr>
            		</table>
       	      </td>
    		</tr>
		...
		<tr>
		    <td>
	        	    ...
	        	    <tr>
                	    ...
                	    <tr class="cellbgprint">
                    	 	<td width="460"><div class="noprint"><?php if($db_submitter_comments) {echo $db_submitter_comments;} ?></div></td>
                	    </tr>
            		</table>
   	      </td>
    		</tr>
	...
	<td width="468" colspan="6">
	  ...
	  <p align="left" class="style1">&nbsp; </p></td>
        ...
        <tr>
          ...
          <a href="javascript:self.close()" style="no-print">close this page</a>
          </td>
    		</tr>
	    </table>
        </td>
