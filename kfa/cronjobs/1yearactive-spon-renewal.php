...
//$sql10 = "update IP_PROFILES set USER_TITLE='' where USER_OID ='$user_oid'";
	...
	fputs($fd, "It is time to renew your Family Membership for Kids With Food Allergies! We trust you have found the Family Membership helpful to you and your family, and we encourage you to renew your Family Membership with us so you can continue to have full access our growing recipe collection and educational resources, and interact on our private Family Member support forums.\n");
	fputs($fd, "Membership is still only $25 a year, and provides day-to-day access to our awesome recipe collection, premium resources, a private support area and more. \n\n");

	fputs($fd, "Renew or purchase a Family Membership by going to https://www.kidswithfoodallergies.org/membership_purchase.html ($25 a year\n\n");
	...
	fputs($fd, "If we do not hear from you, your Family Membership will expire in 30 days. You will still be able to read and post on our Support Forums, but do not have access to our Recipes or premium resources. If you have signed up for our biweekly newsletters, you will still continue to receive your issues.\n\n");
	...
	$weekmessage .= "Have you taken advantage of our awesome Safe Eats Recipe collection with more than 1,300 recipes you can search by allergen(s) you need to avoid to come up with ideas for dinner tonight? http://kidswithfoodallergies.org/recipes/introduction.php\n\n";
	$weekmessage .= "If you need help with finding what you are looking for or if you need help logging in to access our support forums, recipes or resources, we invite you to contact us at info@kidswithfoodallergies.org.\n\n";
...
mail($myemail, $subject, $weekmessage, $mailheaders);
	...
	$weekmessage .= "Membership is still only $25 a year, and provides day-to-day access to our awesome recipe collection, premium resources, a private support area and more. \n\n";
	...
	$weekmessage .= "If we do not hear from you, your Family Membership will expire automatically at the conclusion of your 12 month subscription period. \n\n";
...
if ($left == '7') {
	...
	$weekmessage .= "To renew your Family Membership you can go to https://www.kidswithfoodallergies.org/membership_purchase.html\n\n";
	$weekmessage .= "If your circumstances have changed and you are unable to afford the cost of renewal, we will be happy to provide a sponsored Family Membership for you. You will need to request a sponsored Family Membership  by going to http://www.kidswithfoodallergies.org/sponsormem.html \n\n";
	$weekmessage .= "If we do not hear from you, your Family Membership will expire automatically at the conclusion of your 12 month subscription. \n\n";
...
// Send out an email if they have not signed up a month after their stuff expires
	...
	$weekmessage .= $username;
	$weekmessage .= ",\n\n";
	$weekmessage .= "Your Family Membership has expired and we miss you being a part of our wonderful community! Since we have not heard from you, your Family Membership expired automatically at the conclusion of your 12 month subscription period.\n\n";
