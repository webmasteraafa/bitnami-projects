...
function changePassword( $pwd, $userId )
{
       ...
       $sql = "update myuser set password=PASSWORD('$newpassword'), salt='$salt' where id='$userId'";
       mysql_query( $sql ) or die ( "Error updating password: " . mysql_error() );
       return true;
}

function drawVolunteerResetDropDown($name, $default, $changeHandler, $idSelected)
{
...
function drawBookTitleDropDown($name, $default, $changeHandler, $idSelected)
{
	$sql = "select * from cookrating order by bookname";
	$result = mysql_query( $sql ) or die( "Error in drawStyleDropDown(): " . mysql_error() . "  Query: $sql" );
	echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
...
function DrawAppDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
...
function drawYesNoDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
...
function drawHTMLDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
	echo ">";
		echo "<option value=''></option>";
		if ($value == 'html')
			echo "<option value='html' selected>Do NOT format the page for me</option>";
		else
			echo "<option value='html'>Do NOT format the page for me</option>";
		if ($value == 'no_html')
			echo "<option value='no_html' selected>Use php to format the Page</option>";
		else
			echo "<option value='no_html'>Use php to format the Page</option>";
	echo "</select>";
}

function DrawResSizeDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
	echo ">";
		echo "<option value=''></option>";
		if ($value == 'part')
			echo "<option value='part' selected>Show only 2000 Characters</option>";
		else
			echo "<option value='part'>show only 2000 Characters</option>";
		if ($value == 'all')
			echo "<option value='all' selected>Show Entire Tip</option>";
		else
			echo "<option value='all'>Show Entire Tip</option>";
	echo "</select>";
}
...
function drawWhatEmailDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
	echo ">";
		echo "<option value=''></option>";
		if ($value == 'noemail')
			echo "<option value='noemail' selected>No Email</option>";
		else
			echo "<option value='noemail'>No Email</option>";
		if ($value == 'welcomespon')
			echo "<option value='welcomespon' selected>Welcome, I have added you as a Sponsored FM</option>";
		else
			echo "<option value='welcomespon'>Welcome, I have added you as a Sponsored FM</option>";
		if ($value == 'welcomecomp')
			echo "<option value='welcomecomp' selected>Welcome, I have added you as a Complimentary FM</option>";
		else
			echo "<option value='welcomecomp'>Welcome, I have added you as a Complimentary FM</option>";
		if ($value == 'welcomepaid')
			echo "<option value='welcomepaid' selected>Thank you for becoming KFA FM (Paid)</option>";
		else
			echo "<option value='welcomepaid'>Thank you for becoming KFA FM (Paid)</option>";
		if ($value == 'declined')
			echo "<option value='declined' selected>Your Sponsored Membership has been Declined</option>";
		else
			echo "<option value='declined'>Your Sponsored Membership has been Declined</option>";
		if ($value == 'forget')
			echo "<option value='forget' selected>Did you forget to renew your membership?</option>";
		else
			echo "<option value='forget'>Did you forget to renew your membership?</option>";
		if ($value == 'renewfm')
			echo "<option value='renewfm' selected>Thank you for renewing your PAID Family Membership.</option>";
		else
			echo "<option value='renewfm'>Thank you for renewing your PAID Family Membership.</option>";	
		if ($value == 'renewsponsor')
			echo "<option value='renewsponsor' selected>Thank you for renewing your Sponsored Family Membership.</option>";
		else
			echo "<option value='renewsponsor'>Thank you for renewing your Sponsored Family Membership.</option>";				

	echo "</select>";
}

function drawSendEmailDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
	echo ">";
		...
		if ($value == 'noemail')
			...
			echo "<option value='noemail'>No Email</option>";
		if ($value == 'sendemail')
			echo "<option value='sendemail' selected>Send Email</option>";
		else
			echo "<option value='sendemail'>Send Email</option>";
	echo "</select>";
}
...
function drawTaskStatusDropDown($name,$value, $changeHandler)
{
	...
	echo ">";
		...
		if ($value == 'pending')
			...
			echo "<option value='pending'>Pending</option>";
		if ($value == 'new_task')
			echo "<option value='new_task' selected>New Task</option>";
		else
...
function drawInPositionDropDown($name,$value, $changeHandler)
{
	...
	echo ">";
		echo "<option value=''></option>";
		if ($value == 'within')
			echo "<option value='within' selected>Within scope of contract</option>";
		else
			echo "<option value='within'>Within scope of contract</option>";
		if ($value == 'outside')
			echo "<option value='outside' selected>Outside scope of contract</option>";
		else
			echo "<option value='outside'>Outside scope of contract</option>";
	echo "</select>";
}

function GetICPosition($position)
{
	if ($position == 'within') echo "Within scope of contract";
	if ($position == 'outside') echo "Outside scope of contract";
}

function drawEmPositionDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
	echo ">";
		echo "<option value=''></option>";
		if ($value == 'mem_coor')
			echo "<option value='mem_coor' selected>Membership Coordinator</option>";
		else
			echo "<option value='mem_coor'>Membership Coordinator</option>";
		if ($value == 'dev_coor')
			echo "<option value='dev_coor' selected>Development Coordinator</option>";
		else
			echo "<option value='dev_coor'>Development Coordinator</option>";
		if ($value == 'pub_relations')
			echo "<option value='pub_relations' selected>Public Relations</option>";
		else
			echo "<option value='pub_relations'>Public Relations</option>";
		if ($value == 'ceo')
			echo "<option value='ceo' selected>CEO</option>";
		else
			echo "<option value='ceo'>CEO</option>";			
		if ($value == 'con_ed')
			echo "<option value='con_ed' selected>Content Editing</option>";
		else
			echo "<option value='con_ed'>Content Editing</option>";			
		if ($value == 'con_writ')
			echo "<option value='con_writ' selected>Content Writing</option>";
		else
			echo "<option value='con_writ'>Content Writing</option>";						
		if ($value == 'admin')
			echo "<option value='admin' selected>Administrative</option>";
		else
			echo "<option value='admin'>Administrative</option>";			
		if ($value == 'news_pub')
			echo "<option value='news_pub' selected>Newsletter Publication</option>";
		else
			echo "<option value='news_pub'>Newsletter Publications</option>";			
		if ($value == 'online_com_man')
			echo "<option value='online_com_man' selected>Online Community Management</option>";
		else
			echo "<option value='online_com_man'>Online Community Management</option>";
		if ($value == 'accounting')
			echo "<option value='accounting' selected>Accounting</option>";
		else
			echo "<option value='accounting'>Accounting</option>";
		if ($value == 'web_development')
			echo "<option value='web_development' selected>Web Development</option>";
		else
			echo "<option value='web_development'>Web Development</option>";
		if ($value == 'grants_proposals')
			echo "<option value='grants_proposals' selected>Grants and Proposals</option>";
		else
			echo "<option value='grants_proposals'>Grants and Proposals</option>";
		if ($value == 'ed_program_man')
			echo "<option value='ed_program_man' selected>Education Program Management</option>";
		else
			echo "<option value='ed_program_man'>Education Program Management</option>";
		if ($value == 'fundraising')
			echo "<option value='fundraising' selected>Fundraising</option>";
		else
			echo "<option value='fundraising'>Fundraising</option>";	
		if ($value == 'rdatabase')
			echo "<option value='rdatabase' selected>Recipe Database</option>";
		else
			echo "<option value='rdatabase'>Recipe Database</option>";		
		if ($value == 'other')
			echo "<option value='other' selected>Other</option>";
		else
			echo "<option value='other'>Other</option>";			
...
function GetEMPosition($position)
{
	if ($position == 'mem_coor') echo "Membership Coordinator";
	if ($position == 'dev_coor') echo "Development Coordinator";
	if ($position == 'pub_relations') echo "Public Relations";
	if ($position == 'ceo') echo "CEO";
	if ($position == 'admin') echo "Administrative";
	if ($position == 'news_pub') echo "Newsletter Publication";
	if ($position == 'other') echo "Other";
	if ($position == 'con_ed') echo "Content Editing";
	if ($position == 'con_writ') echo "Content Writing";
	if ($position == 'online_com_man') echo "Online Community Management";
	if ($position == 'accounting') echo "Accounting";
	if ($position == 'web_development') echo "Web Development";
	if ($position == 'grants_proposals') echo "Grants and Proposals";
	if ($position == 'ed_program_man') echo "Education Program Management";
	if ($position == 'fundraising') echo "Fundraising";
...
function drawPreviewDropDown($name,$value, $changeHandler)
{
        echo "<select name='$name' size='1' ";
	if ( $changeHandler != "")
		echo " onchange=$changeHandler ";
	echo ">";
		echo "<option value=''></option>";
		if ($value == 'preview')
			echo "<option value='preview' selected>Preview</option>";
		else
			echo "<option value='preview'>Preview</option>";

		if ($value == 'no_preview')
			echo "<option value='no_preview' selected>Not a Preview</option>";
		else
			echo "<option value='no_preview'>Not a Preview</option>";
