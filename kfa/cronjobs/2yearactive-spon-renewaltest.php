...
//$sql10 = "update IP_PROFILES set USER_TITLE='' where USER_OID ='$user_oid'";
	...
	*/
	...
	fputs($fd, "It is time to renew your Family Membership for Kids With Food Allergies! Your two year membership has ended. We trust you have found the Family Membership helpful to you and your family, and we encourage you to renew your Family Membership with us so you can continue to have full access to our growing recipe collection and educational resources, interact on our Friends Connection service, join in on our hosted live chats, and receive our twice-yearly magazine, Support Net.\n");
	fputs($fd, "Membership is still only $25 a year, a small fee that provides day-to-day access to our awesome recipe collection, premium resources, Friends Connection and more. To renew your Family Membership you can go to https://www.kidswithfoodallergies.org/membership_purchase.html \n");
	...
	*/
	...
	$weekmessage .= "Have you tried logging in to our terrific Support Forums so you can connect with other parents to share information, ask your questions, or to connect with other parents online? http://www.kidswithfoodallergies.org/eve/forums\n\n";
	$weekmessage .= "Have you submitted a profile to our Friends Connection so that you can find friends with similar food allergies in your local area? http://www.kidswithfoodallergies.org/food_allergy_social_network.html\n\n";
...
*/
	...
	$weekmessage .= "Membership is still only $25 a year or 2 years for $40, and provides day-to-day access to our awesome recipe collection, premium resources, Friends Connection and more. To renew your Family Membership you can go to https://www.kidswithfoodallergies.org/membership_purchase.html\n\n";
	...
	$weekmessage .= "If we do not hear from you, your Family Membership will expire automatically at the conclusion of  subscription period which began on ";
	$weekmessage .= $signupdate;
	$weekmessage .= ",  and your membership will revert to Associate Membership status.  Associate Members can read and post on our Support Forums, but do not have access to our recipes or Friends Connection. \n\n";
...
*/
	...
	$weekmessage .= "Membership is still only $25 a year or 2 years for $40, and provides ay-to-day access to our awesome recipe collection, premium resources, Friends Connection and more.\n\n";
...
*/
	...
	$weekmessage .= $username;
	$weekmessage .= ",\n\n";
	$weekmessage .= "Your Family Membership has expired and we miss you being a part of our wonderful community! Since we have not heard from you, your Family Membership expired automatically at the conclusion of your subscription period which began on ";
	$weekmessage .= $signupdate;
	$weekmessage .= ", and your membership has reverted to Associate Membership status.  As an Associate Member, you can login to our support forums to read and post; but you will not have access to Safe Eats Recipes or Friends Connection.\n\n";
