...
if ($to == '') $salesemail = 'webmaster@kidswithfoodallergies.org';
if ($to == '') $salesname = 'Webmaster';
...
<meta name="revisit-after" content="7 days" /><!-- InstanceEndEditable -->
...
<div class="ltgreybox186" align="left">
       <a href="http://www.kidswithfoodallergies.org/contactus.html" class="style27">Contact Information</a>
        <p><a href="http://www.kidswithfoodallergies.org/brochure.php" class="style27">Request KFA Brochures</a></p>
</div>                             
       <br /> 
...
<div align="center">
    ...
    <a href="whatsnew.html" class="style24" rel="self">What's New</a>      <a 
    href="recipes.html" class="style24" rel="self">Allergy-Free Recipes</a>      <a 
    href="resourcesnew.php" class="style24" rel="self">Parent Education Resources</a>         <a 
    href="faalerts.php" class="style24" rel="self">Food Allergy Alerts</a>        
    <a href="interlink.html" class="style24" rel="self">Allergy Links</a><br />        
    <a href="donate.html" class="style24" rel="self">Donate</a>   
    ...
    href="about.html" class="style24" rel="self">About</a> 
...
<?
    $subject = str_replace("& amp ;", "&", (htmlentities(stripslashes($_REQUEST['subject']), ENT_QUOTES)));
	$body = str_replace("& amp ;", "&", (htmlentities(stripslashes($_REQUEST['body']), ENT_QUOTES)));
	$name = str_replace("& amp ;", "&", (htmlentities(stripslashes($_REQUEST['name']), ENT_QUOTES)));

if (($to == 'webmaster') || ($to == 'info')) {
	$thisdate = date("Y-m-d H:m:s");


	$sql = "insert into emailreply set thisdate='$thisdate', toemail='$to', name='".addslashes($name)."', subject='".addslashes($subject)."', email='$email', body='".addslashes($body)."'";
	mysql_query( $sql ) or die( "Error creating new volenteer: " . mysql_error() . " Query: $sql " );

	$sql1 = "select * from emailreply where body='".addslashes($body)."' and name='".addslashes($name)."' and subject='".addslashes($subject)."' and email='$email'";
	...
	$sql = "insert into emailreply_fund set thisdate='$thisdate', toemail='$to', name='".addslashes($name)."', subject='".addslashes($subject)."', email='$email', body='".addslashes($body)."'";
	mysql_query( $sql ) or die( "Error creating new volenteer: " . mysql_error() . " Query: $sql " );

	$sql1 = "select * from emailreply_fund where body='".addslashes($body)."' and name='".addslashes($name)."' and subject='".addslashes($subject)."' and email='$email'";
	$result1 = mysql_query( $sql1 ) or die( "Error querying Vendor list: " . mysql_error() . " Query: $sql1 " );
	$row1 = mysql_fetch_array( $result1 );
	...
	$sql = "insert into emailreply_support set thisdate='$thisdate', toemail='$to', name='".addslashes($name)."', subject='".addslashes($subject)."', email='$email', body='".addslashes($body)."'";
	mysql_query( $sql ) or die( "Error creating new volenteer: " . mysql_error() . " Query: $sql " );

	$sql1 = "select * from emailreply_support where body='".addslashes($body)."' and name='".addslashes($name)."' and subject='".addslashes($subject)."' and email='$email'";
	$result1 = mysql_query( $sql1 ) or die( "Error querying Vendor list: " . mysql_error() . " Query: $sql1 " );
	$row1 = mysql_fetch_array( $result1 );
	...
	$sql = "insert into emailreply_media set thisdate='$thisdate', toemail='$to', name='".addslashes($name)."', subject='".addslashes($subject)."', email='$email', body='".addslashes($body)."'";
	mysql_query( $sql ) or die( "Error creating new volenteer: " . mysql_error() . " Query: $sql " );

	$sql1 = "select * from emailreply_media where body='".addslashes($body)."' and name='".addslashes($name)."' and subject='".addslashes($subject)."' and email='$email'";
	$result1 = mysql_query( $sql1 ) or die( "Error querying Vendor list: " . mysql_error() . " Query: $sql1 " );
	$row1 = mysql_fetch_array( $result1 );
