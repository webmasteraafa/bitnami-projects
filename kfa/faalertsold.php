...
<html><!-- InstanceBegin template="/Templates/alertmain.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<meta name="description" content="Kids With Food Allergies offers a Food Recall Alert for parents managing food allergies. These alerts are issued by the FDA concerning contamination of food by common food allergens.">
...
<meta name="author" content="webmaster@kidswithfoodallergies.org">
<link rel="alternate" type="application/rss+xml"
	title="Kids With Food Allergies" href="kfafeed.xml">
<?php
include ("config.php");
?>
<script language = "JavaScript">
  ...
  {
    postwindow=window.open("http://kidswithfoodallergies.org/groupee/forums?a=dl&f=1140035662&m=6910066223&x_id=FA-"+id+"&x_subject="+subject+"&x_link=http://kidswithfoodallergies.org/faalerts.php", "","toolbar=no,resizable=no,scrollbars=yes,width=600,height=800");
...
<form method="post" action="http://www.kidswithfoodallergies.org/newsletter_sign-up.php">
    ...
    <tr valign="top">
      <td colspan="2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
        		<tr bgcolor="#E5DEFF" valign="top" align="left">
		          <td >
            	    <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CC3300">
		              <tr valign="top" bordercolor="#FFFFFF" bgcolor="#CCCCCC" align="left">
					  <td colspan="2" bgcolor="#CC3300" height="25" bordercolor="#FFFFFF" valign="middle"><span class="stylewhite3"><strong>&nbsp;&nbsp;
            		    allergy alerts </strong></span>
				    </td>
              		  </tr>
		          </table>
                    ...
                    <tr valign="middle" bordercolor="#FFFFFF" bgcolor="#ffffff" align="left">
                      <td valign="top"><p><a href="faalerts.php" class="style27">U.S. FDA Recalls</a></p>
      ...
      <td colspan="2" align="left" bordercolor="#FFFFFF">
		...
		U.S. FDA and USDA Food Allergy Recall Alerts<!-- InstanceEndEditable -->
	</h1>
            </div></td>
          </tr>
        </table>
...
?>
  ...
  <table width="750" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <p align="center" class="style24">Page last updated 10/26/2007</p>
