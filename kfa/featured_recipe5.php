...
<title>Free Allergy Recipe - Allergy Free Wacky Cake</title>
<meta name="keywords" content="wacky cake recipe, allergy free cake recipe, milk free egg free cake, allergy free cake, recipe, peanut allergy, dairy free recipes, dairy free, food allergies, food allergy, wheat free recipes, egg free recipes, wheat free, nut free, peanut free, milk free recipes, food allergy recipes, milk allergy, egg allergy, gluten free," />
<meta name="description" content="This wacky cake recipe is milk-free, egg-free, gluten-free, wheat-free and more. KFA's allergy-free recipe database is filled with hundreds of recipes that are allergy-friendly.  Free featured recipes offer allergy-free desserts, main dishes and more." />
<?
...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->Featured Allergy-Free Recipe: Milk-free Egg-free Wacky Cake<!-- InstanceEndEditable --></h1>
</div>
...
<br />
      ...
      <table align="center" cellpadding="2" width="520">
            <tr>
	            <td>
                  ...
                  <table  border="0" cellpadding="1" cellspacing="2" id="information" >
                        <tr>
                           <td class="header" width="490"><b>Recipe Information</b>&nbsp;&nbsp;</td>
                        </tr>
                        <tr class="cellbg">
    		...
    		<tr>
		    <td>
            	   <table  border="0" cellpadding="1" cellspacing="2" id="ingredients" >
	        	      <tr>
                     <td class="header" width="490"><li><b>Ingredients&nbsp;&nbsp;</b></li></td>
                  </tr>
                	    <tr class="cellbg">
                    		<td width="490" class="resultspacing"><?php while($row = mysql_fetch_array($result2, MYSQL_NUM))
         ...
         echo '<br>';
    		...
    		<tr>
		    <td>
            		<table  border="0" cellpadding="1" cellspacing="2" id="instructions">
	        	    <tr>
                    		<td class="header" width="490"><li><b>Instructions</b></li></td>
                	    </tr>
                	    <tr class="cellbg">
                    		<td class="resultspacing" style="padding:5px;"><?php if($db_instructions) {echo $db_instructions;} ?></td>
                	    </tr>
            		</table>        	    </td>
    		</tr>
		...
		<tr>
		    <td>
            		<table  border="0" cellpadding="1" cellspacing="2" id="comments" >
	        	    <tr>
                    		<td class="header" width="490"><li><b>Comments&nbsp;&nbsp;</b></li></td>
                	    </tr>
                	    <tr class="cellbg">
                    	 	<td class="resultspacing" style="padding:5px;"><?php if($db_picture) {echo "<img src=\"http://www.kidswithfoodallergies.org/ironchef/".$db_picture."\" alt=\"".$db_picalt."\"  border=\"0\" class=\"right\" />";}
    		...
    		<tr>
		    <td>
            		<table  border="0" cellpadding="1" cellspacing="2" id="substitutions" >
	        	          <tr>
                    		<td class="header" width="490"><li><b>Substitutions&nbsp;&nbsp;</b></li></ul></td>
                	    </tr>
                	    <tr class="cellbg">
                    		<td class="resultspacing" style="padding:5px;"><?php if($db_subst_notes) {echo $db_subst_notes;} ?></td>
                	    </tr>
            		</table>        	    </td>
    		</tr>
...
pageTracker._trackPageview("/KathyPWackyCake");
