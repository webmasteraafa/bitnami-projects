...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->
		Featured Recipes<!-- InstanceEndEditable --></h1>
</div>
<div class="ltgreyboxmainR">
      ...
      <!-- Start pasting your code right here !!! -->           
              ...
              <td><tr></td></tr>
	            <tr>
                  ...
                  <table align="center" border="0" cellpadding="1" cellspacing="2" id="information" >
                        <tr>
                           <td class="header" width="460">&nbsp;Recipe Information&nbsp;&nbsp;</td>
                        </tr>
                        <tr class="cellbg">
         ...
         echo '<br>';
		    ...
		    <td>
	        	    ...
	        	    <tr>
                    		<td class="header" width="460">&nbsp;Instructions&nbsp;&nbsp;</td>
                	    </tr>
                	    <tr class="cellbg">
		...
		<tr>
		    <td>
	        	    ...
	        	    <tr>
                    		<td class="header" width="460">&nbsp;Comments&nbsp;&nbsp;</td>
                	    </tr>
                	    <tr class="cellbg">
		    ...
		    <td>
            		<table align="center" border="0" cellpadding="1" cellspacing="2" id="substitutions">
	        	          <tr>
                    		<td class="header" width="460">&nbsp;Substitutions&nbsp;&nbsp;</td>
                	    </tr>
                	    <tr class="cellbg">
        ...
        $other_allergens = substr($other_allergens,0, (strlen($other_allergens) - 2));
         ...
         <tr>
            <?php echo "<td class=\"header\" colSpan=\"6\" >&nbsp;This recipe is free of:</td>"?>
         </tr>
         <tr>
	...
	<tr><td colspan="6"><em>Recipes are shared for your personal use only. You are welcome to enjoy these recipes, but please don't reprint, 
electronically reproduce, repost or redistribute recipes elsewhere without <a class="style30" href="https://www.kidswithfoodallergies.org/email.php?to=info;" onclick="MM_openBrWindow('https://www.kidswithfoodallergies.org/email.php?to=info','','width=500,height=500');return false">obtaining 
permission</a>. For more information, see our <a href="http://www.kidswithfoodallergies.org/tos.html">terms of 
service</a>. Copyright © 2005-2007, Kids With Food Allergies, Inc. All rights reserved. </em></td>
	</tr>
