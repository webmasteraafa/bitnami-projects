...
<title>Canadian Food Allergy Recall Alerts</title>
<meta name="Keywords" content="food allergy recall, food allergy alerts, Canadian food, Canadian alerts, peanut allergy, food allergies, food allergy, wheat free, nut free, peanut free, milk allergy, egg allergy, undeclared food allergens" />
<meta name="Description" content="Kids With Food Allergies provides Canadian Food Allergy Recall Alerts for foods that contain undeclared food allergens." />
...
<script language = "JavaScript" type="text/javascript">
  ...
  {
    postwindow=window.open("http://kidswithfoodallergies.org/groupee/forums?a=dl&f=1140035662&m=6910066223&x_id=CA-"+id+"&x_subject="+subject+"&x_link=http://kidswithfoodallergies.org/caalerts.php", "","toolbar=no,resizable=yes,scrollbars=yes,width=600,height=800");
...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->
		Canadian Food Allergy Recall Alerts<!-- InstanceEndEditable --></h1>
</div>
<div class="ltgreyboxmainR">

			<!-- #BeginEditable "text" -->
<?php
	$sql = "select * from alerts where alerttype='ca' and archived !='ON' order by order_date DESC";
...
<!-- #BeginEditable "date" -->
      <p align="center" class="style24">Page last updated 12/30/2008</p>
      <!-- #EndEditable --></div>
...
pageTracker._trackPageview("/CanadianAlerts");
</script>
<!-- InstanceEndEditable -->
