...
if(isset($_COOKIE['site_2400067262'])){
  ...
  $_SESSION['u_oid'] = $u_oid;
    ...
    //echo "<meta http-equiv=\"Refresh\" CONTENT=\"0; URL=http://www.kidswithfoodallergies.org/recipes.php\">";
}
...
<body>
<?php
  require("recipes/topbanner1.html");
?>
...
<table class="background" cellpadding="0" cellspacing="0" border="0" align="center" width="750">
   <tr>
      <td valign="top" align="left">
         <?php
         require("recipes/leftnavigation1.html"); ?>
      </td>
        ...
        <table width="575" align="center" border="0" cellpadding="5" class="style19" cellspacing="2" bgcolor="#E1E1E1">
          <tr valign="top" bgcolor="#CCCCCC" align="left">
                     ...
                     <h2>Welcome to Our Wonderful Collection of Allergy-Free Recipes!</h2>
                        ...
                        If you would like to come directly to these recipes  (without logging in each time), please <b>bookmark this page</b>. If you have Internet Explorer, click on the &quot;Add to Favorites&quot; button. If you are using Mozilla, FireFox, or Netscape, click on the Bookmarks link at the top of the page. You can also drag/drop this page to your links toolbar.<br /> <br />
                          We encourage and welcome you to share your own favorite recipes and contribute to the growth of our recipe collection. <br /> <br /> <br />
                            <h2> Recipe Search</h2>
                        <form action="recipes/SearchHandling.php" method="POST" name="searchform" onsubmit="validate();">
                                             <table class="style19" style="color:#333333; border:#6AAFCA 2px solid;" align="center" width="488"><tr>   <td align="right" class="celltitlebg">Keyword:&nbsp;<a onclick="showHelp('keywordsearch')" href="javascript:void(0)"><img src="recipes/images/BtnHelpG.gif" border="0" alt="Keyword Help" /></a></td>
                        <td align="left" class="cellbg">
                           <input type="text" name="keyword" id="keyword" class="defaultfont" size="50" /></td>
                     </tr>
                  <tr>
                     <td align="right" class="celltitlebg">Exclude Words:&nbsp;<a onclick="showHelp('excludesearch')" href="javascript:void(0)"><img src="recipes/images/BtnHelpG.gif" border="0" alt="Exclude Words Help" /></a></td>
                     <td align="left" class="cellbg">
                        <input type="text" name="exclude" id="exclude" class="defaultfont" size="50" /></td>
                  </tr>
                  <tr>
                     <td align="right" class="celltitlebg">Category:&nbsp;<a onclick="showHelp('categorysearch')" href="javascript:void(0)"><img src="recipes/images/BtnHelpG.gif" border="0" alt="Category Help" /></a></td>
            ...
            <!-- Allergen checkbox table -->
                  ...
                  <tr>
                     <td class="header" colspan="6">&nbsp;Show Only Recipes that are Free of:&nbsp;<a onclick="showHelp('allergensearch')" href="javascript:void(0)"><img src="recipes/images/BtnHelpB.gif" border="0" alt="Search Help"></a></td>
                  </tr>
                  <tr>
...
<br />
            ...
            <p><em>You are welcome to enjoy these recipes, but please don't reprint, 
              electronically reproduce, repost or redistribute recipes elsewhere without <a href="http://www.kidswithfoodallergies.org/email.php?to=info;" onclick="MM_openBrWindow('recipes/email.php?to=info','','width=500,height=500');return false">obtaining 
                permission</a>. <br />
