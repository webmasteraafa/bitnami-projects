...
<title>Free Allergy Recipes: Chicken Curry</title>
<meta name="keywords" content="allergy free recipe, peanut free, dairy free recipes, dairy free, food allergies, food allergy, POFAK, kids with food allergies, egg free, wheat free, nut free, food allergy recipes, chicken, chicken curry, curry," />
<meta name="description" content="Chicken Curry: Allergy-free recipe database filled with hundreds of recipes that are allergy-friendly.  This free featured recipe offers an allergy-free main dish." />
<?
...
<br />
      ...
      <?require("recipes-signup.php"); ?>
	  
<!-- InstanceEndEditable --></div><!--endsleftcolumn--></td>
 <td valign="top" width="538" colspan="1">    
<div class="maintextrightR">     
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->Featured Allergy-Free Recipe: Chicken Curry<!-- InstanceEndEditable --></h1>
</div>
	            ...
	            <td>
                  <table border="0" align="center" cellpadding="1" cellspacing="2" id="ingredients" >
                     ...
                     <td class="title" align="center">
                       <b>Allergy-Free Main Dish Recipe:</b> <?php echo "<b>$db_name </b><br>
					   A peanut- and milk-free version of a classic dish.<br>"?>
                  ...
                  <table align="center" border="0" cellpadding="1" cellspacing="2" id="information" >
				    ...
				    <?php if($db_source) {echo 'Recipe Created By: '.$db_source.'<br>';} ?></td><td width="60" valign="top"><script type="text/javascript">digg_url = 'http://www.kidswithfoodallergies.org/chicken_curry.php'; digg_bgcolor = '#C0E688'; digg_skin = 'normal'; digg_window = 'new';</script><script src="http://digg.com/tools/diggthis.js" type="text/javascript"></script></td>
                	    </tr>
       		   </td>
            </tr>
	      </table>
...
pageTracker._trackPageview("/ChickenCurry");
