...
<title>Free Allergy Recipes: Buffalo Chicken Dip</title>
<meta name="keywords" content="allergy free recipe, buffalo chicken, dip, recipe, milk-free dip, kids with food allergies, milk-free, gluten free, dairy free recipes, dairy free, food allergies, food allergy, POFAK, peanut free, egg free, wheat free, nut free, food allergy recipes" />
<meta name="description" content="Buffalo Chicken Dip: This recipe is free of milk, egg, peanut, sesame, nuts, wheat, gluten and more.  This free featured recipe offers an allergy-free recipe for the taste of classic buffalo wings. Kids With Food Allergies' allergy-free recipe database is filled with hundreds of recipes that are allergy-friendly. " />
<meta name="zoomimage" content="zoomimg/buffalochickendip.jpg" />
<!-- InstanceEndEditable -->
...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->Featured Allergy-Free Recipe: Buffalo Chicken Dip<!-- InstanceEndEditable --></h1>
</div>
	            ...
	            <td>
                  <table border="0" align="center" cellpadding="1" cellspacing="2" id="ingredients" >
                     ...
                     <td class="title" align="center">
                       <b>Allergy-Free Side Dish Recipe:</b> <?php echo "<b>$db_name </b><br>
					   A dairy-free alternative to a classic football party staple.<br>"?>
                  ...
                  <table align="center" border="0" cellpadding="1" cellspacing="2" id="information" >
				    ...
				    <?php if($db_source) {echo 'Recipe Created By: '.$db_source.'<br>';} ?></td><td width="60" valign="top"><script type="text/javascript">digg_url = 'http://www.kidswithfoodallergies.org/buffalo_chicken_dip.php'; digg_bgcolor = '#C0E688'; digg_skin = 'normal'; digg_window = 'new';</script><script src="http://digg.com/tools/diggthis.js" type="text/javascript"></script></td>
                	    </tr>
       		   </td>
            </tr>
	      </table>
            ...
            <p>You are welcome to enjoy these recipes, but please don't reprint, 
              electronically reproduce, repost or redistribute recipes elsewhere without <a class="style30" href="email.php?to=info;" onclick="MM_openBrWindow('email.php?to=info','','width=500,height=500');return false">obtaining 
                permission</a>. For more information, see our <a href="http://www.kidswithfoodallergies.org/tos.html">terms of 
                  service</a>. 
            <p><em>Copyright &copy; 2005-2009, Kids With Food Allergies, Inc. All rights reserved.</em></em></td></tr></table>
            <!-- #EndEditable --></div>
</div><!--endsmaincolumn-->
</td></tr></table>
</div><!--endsmainbox-->
...
<!-- #BeginEditable "date" -->
      <p>Page last updated 1/18/2009</p>
      <!-- #EndEditable --></div>
...
pageTracker._trackPageview("/BuffaloChickenDip");
