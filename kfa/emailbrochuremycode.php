...
<?php
	...
	$sql = "insert into brochure set datesub='$datesub', name='$name', businessname='$businessname', email='$email', address1='$address1', address2='$address2', city='$city', state='$state', postal_code='$postal_code', quantity='$quantity', comments='$comments', distributed='$distributed', phone='$phone', sent='no'";
