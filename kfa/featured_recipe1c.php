...
<title>Allergy Free Recipes for Kids With Food Allergies</title>
<meta name="keywords" content="food allergies, food allergy, nonprofit, charity, tax-deductible, donate, kids with food allergies, peanut allergy, POFAK, food allergy recipes, milk allergy, egg allergy, nonprofit organization, ways to give, fundraisers," />
<meta name="description" content="Parents of food allergic children have shared hundreds of their favorite recipes that are milk-free, egg-free, soy-free, nut-free, peanut-free, wheat-free, gluten-free, sesame-free, fish-free, and more. Our growing database allows you to search to meet your special dietary needs, or you can browse by category." />
...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->Allergy Free Recipe: Cake Icing<!-- InstanceEndEditable --></h1>
</div>
      ...
      <table align="center" cellpadding="2" cellspacing="10">
        ...
        $other_allergens = substr($other_allergens,0, (strlen($other_allergens) - 2));
         ...
         <tr>
           ...
           <input type="text" disabled class="defaultfont" name="other1" size="60" id="other1" value="<?php echo $other_allergens; ?>">           </td>
         </tr>
...
pageTracker._trackPageview("/FeaturedRecipe1");
