...
<title>Free Allergy Recipes | Pumpkin Muffins with Seed Streusel</title>
<meta name="keywords" content="allergy free recipe, food allergy recipes, peanut free, dairy free recipes, dairy free, milk free, food allergies, food allergy, POFAK, kids with food allergies, egg free, wheat free, nut free, muffins, muffin, pumpkin, pumpkin seed, streusel, wheat free muffin" />
<meta name="description" content="Pumpkin Muffins with Pumpkin Seed Streusel: This recipe is perfect for fall brunches.  The roasted pumpkin seed streusel is a great alternative to nut toppings for muffins and makes this recipe safe for those with peanut or tree nut allergy.  This free featured recipe offers an allergy-free muffin made without milk or dairy, wheat, soy, egg, nuts, sesame, and other common allergens. The Kids With Food Allergies allergy-free recipe database is filled with hundreds of recipes that are allergy-friendly." />
<?
...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->Featured Allergy-Free Recipe: Wheat Free Pumpkin Muffins<!-- InstanceEndEditable --></h1>
</div>
	            ...
	            <td>
                  <table border="0" align="center" cellpadding="1" cellspacing="2" id="ingredients" >
                     ...
                     <td class="title" align="center">
                            <h4>Allergy-Free Muffin Recipe:</h4> <?php echo "<b>$db_name </b><br>
					   Pumpkin muffins are a perfect fall brunch menu item. These muffins have a roasted pumpkin seed streusel to replace a typical nut topping to make this recipe safe for those with peanut or nut allergy.<br>"?>
...
pageTracker._trackPageview("/PumpkinStreuselMuffins");
