...
function drawTopicDropDown($name,$value, $changeHandler)
{
	...
	echo ">";
		...
		if ($value == 'food-safety-labeling')
			echo "<option value='food-safety-labeling' selected>Product Safety & Labeling</option>";
		else
			echo "<option value='food-safety-labeling'>Product Safety & Labeling</option>";
		...
		if ($value == 'parenting')
			echo "<option value='parenting' selected>Parenting</option>";
		else
			echo "<option value='parenting'>Parenting</option>";
...
function GetTopic($topic)
{
	...
	if ($topic == 'food-safety-labeling') echo "Product Safety & Labeling";
	...
	if ($topic == 'parenting') echo "Parenting";
...
function ShowTopic($topic)
{
	...
	if ($topic == 'food-safety-labeling') $topic == "Product Safety & Labeling";
	...
	if ($topic == 'parenting') $topic == "Parenting";
