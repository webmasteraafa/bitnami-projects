            ...
            <tr>
	            <td>
                  ...
                  <table align="center" border="0" cellpadding="1" cellspacing="2" id="information" >
				    ...
				    <?php if($db_source) {echo 'Recipe Created By: '.$db_source.'<br>';} ?></td><td width="60" valign="top"><?php if($db_picture) {echo "<img src=\"http://www.kidswithfoodallergies.org/zoomimg/".$db_picture."\" alt=\"".$db_picalt."\" width=\"125\" height=\"94\" border=\"0\" class=\"right\" />";} ?></td>
                	    </tr>
       		   </td>
            </tr>
	      </table>
