...
<title>Free Allergy Recipes: Sugar Hokey Pokey or Honeycomb</title>
<meta name="keywords" content="food allergy recipes, allergy-free recipe, sugar recipe, sugar syrup, food allergies, food allergy, peanut free, egg free, wheat free, nut free," />
<meta name="description" content="Hokey Pokey or Honeycomb is an allergy-free recipe from Kids With Food Allergies' recipe collection with over 1,000 allergy-friendly recipes.  This recipe offers a treat for kids with multiple food allergies or eosinophilic gastrointestinal disorders." />
<?
if ($db_picture2 != '') echo "<meta name='zoomimage' content='http://www.kidswithfoodallergies.org/zoomimg/".$db_picture2."'>";
?>
<link rel="stylesheet" href="http://kidswithfoodallergies.org/recipes/style.css" type="text/css" />
...
<div class="blueheaderbox"> <h1><!-- InstanceBeginEditable name="title" -->Featured Allergy-Free Recipe: Honeycomb<!-- InstanceEndEditable --></h1>
</div>
...
<br />
      ...
      <table align="center" cellpadding="2" cellspacing="10" style="clear:right">
            <tr>
	            <td>
                  <table border="0" align="center" cellpadding="1" cellspacing="2" id="ingredients" >
                     <tr>
                     <td align="center">
                      <span class="title">Allergy-Free Candy Recipe:<br />
 <?php echo "<b>$db_name </b>"?></span><br>
					  <span class="style19">This allergy-free recipe offers a treat for those with multiple food allergies or eosinophilic gastrointestinal disorder. </span><br>
        ...
        $other_allergens = substr($other_allergens,0, (strlen($other_allergens) - 2));
	       ...
	       <tr>
		     <td>
         <table id="tblAllergenInfo" cellspacing="2" cellpadding="1" align="center" border="0" width="95%">
         <tr>
            <?php echo "<td class=\"header\" colSpan=\"6\" >&nbsp;This recipe is free of:</td>"?>         </tr>
         <tr>
            <td class="celltitlebg">
...
pageTracker._trackPageview("/Honeycomb");
